<script lang="ts">
	...
	let product: Product = getProductPage($page.params.slug);
...
<div class="mx-4">
	<div class="md:grid m-4 md:grid-cols-2">
		...
		<div class="my-auto">
			...
			<button class="font-bold btn variant-ghost-primary" on:click={() => addToCart(product.id)}>
				CHF {product.price} - Add to cart
			</button>
		</div>
	</div>
