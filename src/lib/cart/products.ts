import ag_main from '$lib/img/ag_front.png?enhanced';
import ag_1 from '$lib/img/ag_back.png?enhanced';
import ag_2 from '$lib/img/original/ig-11.png?enhanced';
import ab_main from '$lib/img/ab_front.png?enhanced';
import ab_1 from '$lib/img/ab_back.png?enhanced';
import ab_2 from '$lib/img/original/ig-88.png?enhanced';
import bs_main from '$lib/img/barc_speeder.png?enhanced';
import bs_1 from '$lib/img/barc_speeder_back.png?enhanced';
import bs_2 from '$lib/img/original/barc_speeder.png?enhanced';
import at_main from '$lib/img/atrt.png?enhanced';
import at_1 from '$lib/img/atrt_back.png?enhanced';
import at_2 from '$lib/img/original/at-rt.png?enhanced';
import cd_main from '$lib/img/crab_droid.png?enhanced';
import cd_1 from '$lib/img/crab_droid_back.png?enhanced';
import cd_2 from '$lib/img/original/crab_droid.png?enhanced';
import dd_main from '$lib/img/droideka.png?enhanced';
import dd_1 from '$lib/img/droideka_side.png?enhanced';
import dd_2 from '$lib/img/original/droideka.png?enhanced';
import rc_main from '$lib/img/rancor.png?enhanced';
import rc_1 from '$lib/img/rancor_side.png?enhanced';
import rc_2 from '$lib/img/original/rancor.png?enhanced';
